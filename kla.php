...
<div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">KLASIFIKASI KEBERBAKATAN</h6>
                </div>
                <div class="card-body">
                  <?php if(empty($_GET['ed'])){ ?>
                  <form action='aksi.php' method='POST'>
                    <div class='form-group row'>
                      <label for='inputEmail3' class='col-sm-3 col-form-label'>Klasifikasi</label>
                      <div class='col-sm-9'>
                  ...
                  <?php }else{ 
                    $e=mysqli_fetch_array(mysqli_query($kon, "SELECT * FROM kla WHERE id='$_GET[id]'"));
                    ...
                    <input type='hidden' name='cek' value='j'>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Data Klasifikasi Keberbakatan</h6>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      <?php $ro=mysqli_query($kon, "SELECT * FROM kla");
                    while($r=mysqli_fetch_assoc($ro)){
                        echo"<tr><td>$n</td><td>$r[nm]</td><td>$r[nil]</td>
                        <td><a href='kla.php?id=$r[id]&ed=ed'>Edit</a></td>
                        <td><a href='hps.php?h=kla&id=$r[id]' onClick=\"return confirm('Anda Yakin Ingin Menghapus Data Ini ?')\">hapus</a></td>
                        </tr>";
                    $n++;}
                    ?>
                    </tbody>
